          ...
          <div key={booking.id} className="booking-container">
            ...
            <div className="row">
              ...
              <div className='col-lg-3 mt-1 ms-3'>
                ...
                <div>
                  <div className='mt-3'>
                    <img src={assets.calendar_icon_colored} alt="calendar" className='me-2' />
                ...
                <div>
                  <div className='mt-3'>
                    <img src={assets.location_icon_colored} alt="location" className='me-2 loc-img' />
              ...
              <div className='col-lg-3 price-details'>
                <span className={`px-3 py-1 small rounded-pill ${booking.status === "CONFIRMED" ? "bg-success bg-opacity-25 text-success" : booking.status === "PENDING" ? "bg-warning bg-opacity-25 text-warning" : "bg-danger bg-opacity-25 text-danger"}`}>
                  {booking.status}
                </span>
